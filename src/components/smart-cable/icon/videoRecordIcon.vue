<template>
    <svg t="1716145124432" class="icon" viewBox="0 0 1087 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
        p-id="14001" :width="iconwidth" :height="iconheight">
        <path
            ...
            p-id="14002" :fill="iconcolor"></path>
    </svg>
</template>
<script setup>
defineProps({
