...
export function getGroupAlarmMessage(day) {
  return request({
    url: "/dataapi/alarm-message/getGroupAlarmMessage",
    method: "post",
    data: { day },
  });
}
...
export function getAlarmMessage(day) {
  return request({
    url: "/dataapi/alarm-message/getAlarmMessage",
    method: "post",
    data: { day },
  });
}
...
export function getAlarmConfig(alarmType, serviceId) {
  return request({
    url: "/dataapi/alarm-message/getAlarmConfig",
    method: "post",
    data: { alarmType, serviceId },
  });
}
/**
 * 保存告警配置信息
...
export function searchAlarmMessageHistory(data, pageSize, pageNum) {
  return request({
    url: "/dataapi/alarm-message/searchAlarmMessageHistory",
    method: "post",
    data: { ...data, pageSize, pageNum },
  });
}
...
export function getAlarmAllConfig(serviceId) {
  return request({
    url: "/dataapi/alarm-message/getAlarmAllConfig",
    method: "post",
    data: { serviceId },
  });
}
...
export function searchAlarmMessage(data, pageSize, pageNum) {
  return request({
    url: "/dataapi/alarm-message/searchAlarmMessage",
    method: "post",
    data: { ...data, pageSize, pageNum },
  });
}
...
export function selectWorkOrderAlarmMessageDetails(data, pageSize, pageNum) {
  return request({
    url: "/dataapi/alarm-message/selectWorkOrderAlarmMessageDetails",
    method: "post",
    data: { ...data, pageSize, pageNum },
  });
}
